...
class _AddIncomePageState extends State<AddIncomePage> {
  ...
  // Save income to service and realtime store
  IncomeService.addIncome(income);
  TransactionStore.instance.addIncome(income);
      
      // Update wallet balance
      WalletService.addToWallet(_selectedWallet!.id, income.amount);
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          if (result != null) {
                            ...
                            // If user selected expense category while on income page, switch to expense page
                            if (!isIncome) {
                              // Navigate to expense page with selected category
                              if (mounted) {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
